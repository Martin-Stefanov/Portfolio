...
const NavBar = () => {
  ...
  return (
    // <div className="h-24 w-full min-w-max bg-black top-0">
      <div className="flex justify-between items-center h-24  bg-gray-500">
        <img onClick={() => navigate('/')} className="h-24 cursor-pointer" src="/logo.png" alt="MS-Logo" />
        ...
        <button className='main-button'>My story</button>
